...
function CollectiveS.Notification(_source, theType, message)
    ...
    elseif Config.NotificationType.server == 't-notify' then
        if theType == 1 then
            TriggerClientEvent('t-notify:client:Custom', _source, {style = 'success', duration = 5000, title = 'LICENSE PLATE', message = message, sound = false})
        elseif theType == 2 then
            TriggerClientEvent('t-notify:client:Custom', _source, {style = 'info', duration = 5000, title = 'LICENSE PLATE', message = message, sound = false})
        elseif theType == 3 then
            TriggerClientEvent('t-notify:client:Custom', _source, {style = 'error', duration = 5000, title = 'LICENSE PLATE', message = message, sound = false})
        end
    elseif Config.NotificationType.server == 'col_notify' then
        if theType == 1 then
            TriggerClientEvent('col_notify:client:Custom', _source, {style = 'success', duration = 5000, title = 'LICENSE PLATE', message = message, sound = false})
        elseif theType == 2 then
            TriggerClientEvent('col_notify:client:Custom', _source, {style = 'info', duration = 5000, title = 'LICENSE PLATE', message = message, sound = false})
        elseif theType == 3 then
            TriggerClientEvent('col_notify:client:Custom', _source, {style = 'error', duration = 5000, title = 'LICENSE PLATE', message = message, sound = false})
        end
    ...
    elseif Config.NotificationType.server == 'col_notify_new' then
        if theType == 1 then
            TriggerClientEvent('col_notify:Notify', _source, 'success', 5000, message, 'LICENSE PLATE')
        elseif theType == 2 then
            TriggerClientEvent('col_notify:Notify', _source, 'info', 5000, message, 'LICENSE PLATE')
        elseif theType == 3 then
            TriggerClientEvent('col_notify:Notify', _source, 'error', 5000, message, 'LICENSE PLATE')
        end
    ...
    elseif Config.NotificationType.server == 'okokNotify' then
        if theType == 1 then
            TriggerClientEvent('okokNotify:Alert', _source, "LICENSE PLATE", message, 5000, 'success')
        elseif theType == 2 then
            TriggerClientEvent('okokNotify:Alert', _source, "LICENSE PLATE", message, 5000, 'info')
        elseif theType == 3 then
            TriggerClientEvent('okokNotify:Alert', _source, "LICENSE PLATE", message, 5000, 'error')
        end
